...
/**
 * Calls a Supabase Edge Function by name with a JSON body, using the anon
 * key by default. Pass `authed: true` to include the current user's session
 * JWT instead (required for admin-* functions).
 */
